 ...
 */
class getReservationCovoiturageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationCovoiturageRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationCovoiturageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationCovoiturageRepository.php';

        return $container->privates['App\\Repository\\ReservationCovoiturageRepository'] = new \App\Repository\ReservationCovoiturageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
