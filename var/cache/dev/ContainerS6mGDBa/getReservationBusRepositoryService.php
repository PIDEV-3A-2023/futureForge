 ...
 */
class getReservationBusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationBusRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationBusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationBusRepository.php';

        return $container->privates['App\\Repository\\ReservationBusRepository'] = new \App\Repository\ReservationBusRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
