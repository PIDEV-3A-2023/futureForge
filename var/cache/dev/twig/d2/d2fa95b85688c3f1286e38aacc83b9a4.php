...
/* basefront.html.twig */
class __TwigTemplate_b8832d1daae7dfcd65f175e1c9a5c3a3 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<h1 class=\"mb-4\">Fast &amp; Easy Way To MOVE</h1>
...
\t\t</body>
\t</body>
</html></div></div><section class=\"ftco-section ftco-no-pt bg-light\"><div class=\"container\">
<div class=\"row no-gutters\">
\t<div class=\"col-md-12\tfeatured-top\">
\t\t<div class=\"row no-gutters\">
\t\t\t<div
\t\t\t\tclass=\"col-md-4 d-flex align-items-center\"><!--\t<form action=\"#\" class=\"request-form ftco-animate bg-primary\">
...
\t\t\t\t\t\t<h2 class=\"mb-2\">Feeatured OFFERS</h2>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"row\">
\t\t\t\t\t<div class=\"col-md-12\">
...
\t\t\t\t\t\t\t<h2 class=\"mb-4\">Welcome to THNITY</h2>

\t\t\t\t\t\t\t<p>Tous vos trajets courte et longue distance réalisés sur THNITY.tn sont éligibles à la prime covoiturage annoncée par le gouvernement. Vérifiez votre éligibilité depuis votre profil dès maintenant puis publiez vos prochains trajets en covoiturage !</p>
...
\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-primary py-3 px-4\">Search OFFERS</a>
\t\t\t\t\t\t</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t<span class=\"text\">+216 21789456</span>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<a href=\"#\">
...
\t\t\t</div>
\t\t</div>
\t</footer><!-- loader --><div id=\"ftco-loader\" class=\"show fullscreen\">
...
";
    ...
    {
        return array (  491 => 5,  123 => 60,  117 => 57,  111 => 54,  105 => 51,  99 => 48,  93 => 45,  80 => 35,  49 => 6,  47 => 5,  41 => 1,);
    }
...
", "basefront.html.twig", "C:\\Users\\Foura\\Desktop\\pidev\\Symfony\\prd2\\ghada meddeb\\last version\\thnity_web\\templates\\basefront.html.twig");
    }
}
